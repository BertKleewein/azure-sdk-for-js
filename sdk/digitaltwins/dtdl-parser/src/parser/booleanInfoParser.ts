...
import { BooleanKinds } from "./booleanKinds";
...
export class BooleanInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<BooleanInfo> = referenceInit<BooleanInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: BooleanInfoImpl = elementInfoAsAny as BooleanInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        BooleanInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
