...
export class UnitInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<UnitInfo> = referenceInit<UnitInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: UnitInfoImpl = elementInfoAsAny as UnitInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        UnitInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
