...
export class DateTimeInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<DateTimeInfo> = referenceInit<DateTimeInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: DateTimeInfoImpl = elementInfoAsAny as DateTimeInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        DateTimeInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
