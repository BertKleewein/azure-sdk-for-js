...
export class CommandRequestInfoStatic {
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 3: {
        this.parsePropertiesV3(
          model,
          elementInfo as CommandRequestInfoImpl,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
          parsingErrors,
  ...
  static parsePropertiesV3(
    ...
    for (const propKey in object) {
      ...
      if (
        CommandRequestInfoStatic.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
...
CommandRequestInfoStatic.initialize();
