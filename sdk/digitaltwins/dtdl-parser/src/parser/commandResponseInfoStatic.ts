...
export class CommandResponseInfoStatic {
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 3: {
        this.parsePropertiesV3(
          model,
          elementInfo as CommandResponseInfoImpl,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
          parsingErrors,
  ...
  static parsePropertiesV3(
    ...
    for (const propKey in object) {
      ...
      if (
        CommandResponseInfoStatic.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
...
CommandResponseInfoStatic.initialize();
