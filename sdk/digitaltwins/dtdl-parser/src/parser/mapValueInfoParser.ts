...
import { MapValueKinds } from "./mapValueKinds";
...
export class MapValueInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<MapValueInfo> = referenceInit<MapValueInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: MapValueInfoImpl = elementInfoAsAny as MapValueInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        MapValueInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
