...
export class InterfaceInfoStatic {
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 2: {
        this.parsePropertiesV2(
          model,
          elementInfo as InterfaceInfoImpl,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
          parsingErrors,
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:contents;2":
          valueCount = ContentInfoStatic.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
        ...
        case "dtmi:dtdl:property:schemas;2":
          ComplexSchemaInfoStatic.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
      ...
      if (
        InterfaceInfoStatic.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:extends;3":
          InterfaceInfoStatic.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
            elementInfo._extendsValueConstraints,
...
InterfaceInfoStatic.initialize();
