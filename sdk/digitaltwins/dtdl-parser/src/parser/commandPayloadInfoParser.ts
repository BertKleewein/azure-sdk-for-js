...
export class CommandPayloadInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<CommandPayloadInfo> = referenceInit<CommandPayloadInfo>();
  ...
  public static parsePropertiesV2(
    ...
    for (const propKey in object) {
      ...
      if (
        CommandPayloadInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
