...
export class StringInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<StringInfo> = referenceInit<StringInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: StringInfoImpl = elementInfoAsAny as StringInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        StringInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
