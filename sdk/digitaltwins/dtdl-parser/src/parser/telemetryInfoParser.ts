...
import { TelemetryKinds } from "./telemetryKinds";
...
export class TelemetryInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<TelemetryInfo> = referenceInit<TelemetryInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: TelemetryInfoImpl = elementInfoAsAny as TelemetryInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        TelemetryInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
