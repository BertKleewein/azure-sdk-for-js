...
export class ArrayInfoStatic {
  ...
  static parsePropertiesV2(
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:elementSchema;2":
          ...
          valueCount = SchemaInfoStatic.parseToken(
            ...
            objectPropertyInfoList,
            elementPropertyConstraints,
            elementInfo._elementSchemaValueConstraints,
            aggregateContext,
            parsingErrors,
            propValue,
            elementInfo.id,
            ...
            true,
            allowIdReferenceSyntax,
            elementInfo._elementSchemaAllowedVersionsV2
          );
          if (valueCount < 1) {
            parsingErrors.push(
      ...
      if (
        ArrayInfoStatic.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:elementSchema;3":
          ...
          valueCount = SchemaInfoStatic.parseToken(
            ...
            true,
            allowIdReferenceSyntax,
            elementInfo._elementSchemaAllowedVersionsV3
          );
          if (valueCount < 1) {
            parsingErrors.push(
              createParsingError("dtmi:dtdl:parsingError:propertyCountBelowMin", {
