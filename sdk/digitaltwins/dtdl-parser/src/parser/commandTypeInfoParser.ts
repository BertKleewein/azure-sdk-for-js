...
export class CommandTypeInfoParser {
  ...
  public static tryParseSupplementalProperty(
    ...
    model: Model,
    // eslint-disable-next-line @azure/azure-sdk/ts-use-interface-parameters
    elementInfo: CommandTypeInfoImpl,
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<CommandTypeInfo> = referenceInit<CommandTypeInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: CommandTypeInfoImpl = elementInfoAsAny as CommandTypeInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        CommandTypeInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
