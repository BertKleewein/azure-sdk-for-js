...
export class IntegerInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<IntegerInfo> = referenceInit<IntegerInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: IntegerInfoImpl = elementInfoAsAny as IntegerInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        IntegerInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
