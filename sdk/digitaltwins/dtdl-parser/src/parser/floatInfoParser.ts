...
export class FloatInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<FloatInfo> = referenceInit<FloatInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: FloatInfoImpl = elementInfoAsAny as FloatInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        FloatInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
