...
export class DoubleInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<DoubleInfo> = referenceInit<DoubleInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: DoubleInfoImpl = elementInfoAsAny as DoubleInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        DoubleInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
