...
export class DateInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<DateInfo> = referenceInit<DateInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: DateInfoImpl = elementInfoAsAny as DateInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        DateInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
