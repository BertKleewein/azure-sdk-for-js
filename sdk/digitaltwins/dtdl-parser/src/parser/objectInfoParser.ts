...
export class ObjectInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<ObjectInfo> = referenceInit<ObjectInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: ObjectInfoImpl = elementInfoAsAny as ObjectInfoImpl;
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:fields;2":
          valueCount = ParserCollection.FieldInfoParser.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
            elementInfo._fieldsValueConstraints,
            aggregateContext,
            parsingErrors,
            propValue,
            elementInfo.id,
            ...
            false,
            allowIdReferenceSyntax,
            elementInfo._fieldsAllowedVersionsV2
          );
          if (valueCount < 1) {
            parsingErrors.push(
      ...
      if (
        ObjectInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:fields;3":
          ParserCollection.FieldInfoParser.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
            elementInfo._fieldsValueConstraints,
            ...
            false,
            allowIdReferenceSyntax,
            elementInfo._fieldsAllowedVersionsV3
          );
          continue;
      }
