...
import { MapKeyKinds } from "./mapKeyKinds";
...
export class MapKeyInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<MapKeyInfo> = referenceInit<MapKeyInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: MapKeyInfoImpl = elementInfoAsAny as MapKeyInfoImpl;
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:schema;2":
          ...
          valueCount = ParserCollection.StringInfoParser.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
            elementInfo._schemaValueConstraints,
            aggregateContext,
            parsingErrors,
            propValue,
            elementInfo.id,
            ...
            true,
            allowIdReferenceSyntax,
            elementInfo._schemaAllowedVersionsV2
          );
          if (valueCount < 1) {
            parsingErrors.push(
      ...
      if (
        MapKeyInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:schema;3":
          ...
          valueCount = ParserCollection.StringInfoParser.parseToken(
            ...
            true,
            allowIdReferenceSyntax,
            elementInfo._schemaAllowedVersionsV3
          );
          if (valueCount < 1) {
            parsingErrors.push(
              createParsingError("dtmi:dtdl:parsingError:propertyCountBelowMin", {
