...
export class PropertyInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<PropertyInfo> = referenceInit<PropertyInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: PropertyInfoImpl = elementInfoAsAny as PropertyInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        PropertyInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
