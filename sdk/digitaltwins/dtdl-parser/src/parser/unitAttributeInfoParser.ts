...
export class UnitAttributeInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<UnitAttributeInfo> = referenceInit<UnitAttributeInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: UnitAttributeInfoImpl = elementInfoAsAny as UnitAttributeInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        UnitAttributeInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
