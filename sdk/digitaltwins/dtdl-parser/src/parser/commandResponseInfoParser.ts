...
export class CommandResponseInfoParser {
  ...
  public static tryParseSupplementalProperty(
    ...
    model: Model,
    // eslint-disable-next-line @azure/azure-sdk/ts-use-interface-parameters
    elementInfo: CommandResponseInfoImpl,
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<CommandResponseInfo> = referenceInit<CommandResponseInfo>();
  ...
  public static parsePropertiesV3(
    ...
    const elementInfo: CommandResponseInfoImpl = elementInfoAsAny as CommandResponseInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        CommandResponseInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
