...
export class DurationInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<DurationInfo> = referenceInit<DurationInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: DurationInfoImpl = elementInfoAsAny as DurationInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        DurationInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
