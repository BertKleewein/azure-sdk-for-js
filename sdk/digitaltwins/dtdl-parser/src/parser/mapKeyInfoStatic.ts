...
import { StringInfoStatic } from "./stringInfoStatic";
export class MapKeyInfoStatic {
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:schema;2":
          ...
          valueCount = StringInfoStatic.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
      ...
      if (
        MapKeyInfoStatic.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
