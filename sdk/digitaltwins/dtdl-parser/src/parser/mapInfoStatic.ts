    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:mapKey;2":
          ...
          valueCount = MapKeyInfoStatic.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
            elementInfo._mapKeyValueConstraints,
            aggregateContext,
            parsingErrors,
            propValue,
            elementInfo.id,
            ...
            false,
            allowIdReferenceSyntax,
            elementInfo._mapKeyAllowedVersionsV2
          );
          if (valueCount < 1) {
            parsingErrors.push(
        ...
        case "dtmi:dtdl:property:mapValue;2":
          ...
          valueCount = MapValueInfoStatic.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
            elementInfo._mapValueValueConstraints,
            aggregateContext,
            parsingErrors,
            propValue,
            elementInfo.id,
            ...
            false,
            allowIdReferenceSyntax,
            elementInfo._mapValueAllowedVersionsV2
          );
          if (valueCount < 1) {
            parsingErrors.push(
              createParsingError("dtmi:dtdl:parsingError:propertyCountBelowMin", {
      ...
      if (
        MapInfoStatic.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:mapKey;3":
          ...
          valueCount = MapKeyInfoStatic.parseToken(
            ...
            false,
            allowIdReferenceSyntax,
            elementInfo._mapKeyAllowedVersionsV3
          );
          if (valueCount < 1) {
            parsingErrors.push(
              createParsingError("dtmi:dtdl:parsingError:propertyCountBelowMin", {
        ...
        case "dtmi:dtdl:property:mapValue;3":
          ...
          valueCount = MapValueInfoStatic.parseToken(
            ...
            false,
            allowIdReferenceSyntax,
            elementInfo._mapValueAllowedVersionsV3
          );
          if (valueCount < 1) {
            parsingErrors.push(
              createParsingError("dtmi:dtdl:parsingError:propertyCountBelowMin", {
