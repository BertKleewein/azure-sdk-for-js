...
import { FieldKinds } from "./fieldKinds";
...
export class FieldInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<FieldInfo> = referenceInit<FieldInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: FieldInfoImpl = elementInfoAsAny as FieldInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        FieldInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
