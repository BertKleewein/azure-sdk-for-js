...
import { TimeKinds } from "./timeKinds";
...
export class TimeInfoImpl implements TimeInfo, TypeChecker {
  ...
  public parserClass: Parser = ParserCollection.TimeInfoParser;
  ...
  public _elementValueInstanceRegexPatternV2: RegExp = /^[0-9]{2}:[0-9]{2}:[0-9]{2}(?:\.[0-9]+)?(?:Z|(?:\+|-)[0-9]{2}:[0-9]{2})$/;
  public _elementValueInstanceRegexPatternV3: RegExp = /^[0-9]{2}:[0-9]{2}:[0-9]{2}(?:\.[0-9]+)?(?:Z|(?:\+|-)[0-9]{2}:[0-9]{2})$/;
