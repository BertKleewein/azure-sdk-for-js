...
import { LongKinds } from "./longKinds";
...
export class LongInfoParser {
  ...
  private static parseTypeArray(
    ...
    const elementInfo: Reference<LongInfo> = referenceInit<LongInfo>();
  ...
  public static parsePropertiesV2(
    ...
    const elementInfo: LongInfoImpl = elementInfoAsAny as LongInfoImpl;
    ...
    for (const propKey in object) {
      ...
      if (
        LongInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
