...
export class NamedLatentTypeInfoParser {
  ...
  static parseTypeArray(
    ...
    const elementInfo: Reference<NamedLatentTypeInfo> = referenceInit<NamedLatentTypeInfo>();
  ...
  static parsePropertiesV3(
    ...
    for (const propKey in object) {
      ...
      if (
        NamedLatentTypeInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
