...
export class EnumValueInfoParser {
  ...
  static parseTypeArray(
    ...
    const elementInfo: Reference<EnumValueInfo> = referenceInit<EnumValueInfo>();
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:enumValue;2":
          ...
          elementInfo.enumValue = enumValueValueAndType.value;
          elementInfo._enumValueDatatype = enumValueValueAndType.typeFragment;
          continue;
        case "name":
      ...
      if (
        EnumValueInfoParser.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
