...
export class TelemetryInfoStatic {
    ...
    switch (childAggregateContext.dtdlVersion) {
      case 2: {
        this.parsePropertiesV2(
          model,
          elementInfo as TelemetryInfoImpl,
          objectPropertyInfoList,
          elementPropertyConstraints,
          childAggregateContext,
          parsingErrors,
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:schema;2":
          ...
          valueCount = SchemaInfoStatic.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
      ...
      if (
        TelemetryInfoStatic.tryParseSupplementalProperty(
          model,
          elementInfo,
          objectPropertyInfoList,
          elementPropertyConstraints,
...
TelemetryInfoStatic.initialize();
