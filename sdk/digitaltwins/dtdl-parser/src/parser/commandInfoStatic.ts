...
export class CommandInfoStatic {
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:commandType;2":
          valueCount = CommandTypeInfoStatic.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
        ...
        case "dtmi:dtdl:property:request;2":
          valueCount = CommandPayloadInfoStatic.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
    ...
    for (const propKey in object) {
      ...
      switch (propKey) {
        ...
        case "dtmi:dtdl:property:request;3":
          valueCount = CommandRequestInfoStatic.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
            elementInfo._requestValueConstraints,
        ...
        case "dtmi:dtdl:property:response;3":
          valueCount = CommandResponseInfoStatic.parseToken(
            model,
            objectPropertyInfoList,
            elementPropertyConstraints,
            elementInfo._responseValueConstraints,
